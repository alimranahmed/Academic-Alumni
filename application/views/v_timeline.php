<div class="col-md-6">
    <div class="row">
        <div class='col-md-10' style="margin-top: 10px;">
            <div class="row">
                <form method="post" action="<?php echo site_url('timeline/insertPost')?>">
            ...
            <?php foreach($posts as $post ):?>
                    ...
                    <div class="modal fade" id="editComment<?php echo $comment->id?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form class="form-horizontal" role="form" method="post" action="<?php echo site_url('timeline/editComment/'.$comment->id);?>">
                ...
                <div class="row">
                    Your comment:
                    <form class="form-horizontal" role="form" method="post" action="<?php echo site_url("timeline/insertComment/".$post->id)?>">
                ...
                <div class="modal fade" id="editPost<?php echo $post->id?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form class="form-horizontal" role="form" method="post" action="<?php echo site_url('timeline/editPost/'.$post->id);?>">
                                <div class="modal-body">
                                    <div>
                                        <label>Post</label>

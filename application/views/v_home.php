<div class="col-md-6">
    <div class="row">
        <div class='col-md-10' style="margin-top: 10px;">
            <div class="row">
                <form method="post" action="<?php echo site_url('home/insertPost')?>">
            ...
            <?php foreach($posts as $post ):?>
                <div class="row" style="margin-top: 10px;">
                    ...
                    <a href="<?php echo site_url('home/deletePost/'.$post->id);?>" onclick="return confirm('Are you sure to delete the post?')"><i class="glyphicon glyphicon-trash text-danger"></i></a>
                    <?php endif?>
                    ...
                    <div class="col-md-9">
                        ...
                        <p>Posted by <a href="<?php echo site_url('profile/show/'.$post->userId)?>"><?php echo $post->firstName.' '.$post->lastName?></a>
                            <?php if($post->groupId):?>
                                on <?php echo $group->name?>
                            <?php endif?>
                        </p>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class='col-md-10'>
                            <?php if($comment->userId == $this->session->userdata("user_id")):?>
                                <a href="<?php echo site_url('home/deleteComment/'.$comment->id)?>" onclick="return confirm('Are you sure to delete this comment?')";><i class="glyphicon glyphicon-trash pull-right text-danger"></i></a>
                        ...
                        <div class="modal fade" id="editComment<?php echo $comment->id?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <form class="form-horizontal" role="form" method="post" action="<?php echo site_url('home/editComment/'.$comment->id);?>">
                ...
                <div class="row">
                    Your comment:
                    <form class="form-horizontal" role="form" method="post" action="<?php echo site_url("home/insertComment/".$post->id)?>">
                ...
                <div class="modal fade" id="editPost<?php echo $post->id?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form class="form-horizontal" role="form" method="post" action="<?php echo site_url('home/editPost/'.$post->id);?>">
                                <div class="modal-body">
                                    <div>
                                        <label>Post</label>
...
<div class="col-md-4">
    ...
    <div class="row">
        <?php foreach($friends as $friend):?>
            <div class="col-md-4">
                <img class="img-circle poster-image" src="<?=base_url($friend->photo)?>">
